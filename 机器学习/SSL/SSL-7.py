...
#    data_moe2d,X_moe2d,y_moe2d,X_moe2d_3,y_moe2d_3,X_moe2d_test,y_moe2d_test = read("moe2d")  
    ...
    while cycle < cycles:
        ...
        cats_chance = rfmodel("cats",X_cats,y_cats,X_cats_3,y_cats_3,X_cats_test,y_cats_test)
#        cats_chance = svcmodel("cats",X_cats,y_cats,X_cats_3,y_cats_3,X_cats_test,y_cats_test)
        maccs_chance = gnbmodel("maccs",X_maccs,y_maccs,X_maccs_3,y_maccs_3,X_maccs_test,y_maccs_test)
#        moe2d_chance = gnbmodel("moe2d",X_moe2d,y_moe2d,X_moe2d_3,y_moe2d_3,X_moe2d_test,y_moe2d_test)
        
        cats_added_positive,cats_added_negative = getindex(maccs_chance)
        maccs_added_positive,maccs_added_negative = getindex(cats_chance)
#        moe2d_added_positive,moe2d_added_negative = getindex(cats_chance)

        droplist = getdropindex(cats_added_positive.index,cats_added_negative.index,maccs_added_positive.index,maccs_added_negative.index)
        
        cats_pre_results,cats_prediction = preresults("cats",cycle,data_cats,maccs_added_positive,maccs_added_negative)
        maccs_pre_results,maccs_prediction = preresults("maccs",cycle,data_maccs,cats_added_positive,cats_added_negative)
